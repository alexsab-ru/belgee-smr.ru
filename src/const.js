...
export const SITE_NAME = 'Белджи Партнер Самара';
// Юр лицо
...
export const SITE_DESCR = 'Официальный дилерский центр Белджи Партнер в Самаре';
...
export const LINK_WIDGET_ORGNIZATION = 'CDWZZPOM';
// Ссылки под хедером
